...
import type { PortaCatalogoPublico } from '@/services/publico/catalogo-publico';
...
export const catalogoPublicoMock: PortaCatalogoPublico = {
...
export function obterNomeTimePublico(id: number) {
  return (
...
export function obterNomeCampoPartida(id?: number) {
...
export function obterNomeCampeonatoPublico(id: number) {
  return (
