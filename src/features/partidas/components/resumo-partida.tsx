  ...
  return (
    ...
    >
      ...
      {sumula.gols.length > 0 ? (
        <div className="mt-6">
          <div className="mb-3 flex items-center gap-2">
            ...
            <h3 className="font-display text-lg font-semibold">Gols</h3>
          </div>
          <div className="divide-y divide-border/70 overflow-hidden rounded-2xl border border-border/70">
            {sumula.gols.map((gol, index) => (
              ...
              >
                <div>
                  <p className="text-sm font-semibold text-foreground">{gol.autor}</p>
                  <p className="text-xs text-muted-foreground">{gol.time}</p>
                </div>
                <span className="text-sm font-semibold text-green-dark">{gol.minuto}'</span>
              </div>
            ))}
          </div>
        </div>
      ...
      {cartoes.length > 0 ? (
        <div className="mt-6">
          <div className="mb-3 flex items-center gap-2">
            <ShieldAlert className="h-4 w-4 text-green-dark" aria-hidden="true" />
            <h3 className="font-display text-lg font-semibold">Cartões</h3>
          </div>
            ...
            {cartoes.map((cartao, index) => (
              ...
              >
                <div className="min-w-0">
                  <p className="truncate text-sm font-semibold">{cartao.jogador}</p>
                ...
                <div className="flex shrink-0 items-center gap-2 text-sm font-semibold">
                  ...
                  <span className="text-muted-foreground">{cartao.minuto}'</span>
                </div>
              </div>
            ))}
          </div>
      ...
      {substituicoes.length > 0 ? (
        <div className="mt-6">
          <div className="mb-3 flex items-center gap-2">
            ...
            <h3 className="font-display text-lg font-semibold">Substituições</h3>
          </div>
