...
import type { PartidaPublica } from '@/features/publico/model/public-models';
import {
  getMatchVenueName,
  getPublicTeamName,
  publicCatalogMock,
    ...
    >
      ...
      <div className="mt-6 flex min-h-11 items-center justify-between gap-3 border-t border-border/70 pt-4">
        <p className="flex items-center gap-1.5 text-xs text-muted-foreground">
          ...
          {getMatchVenueName(partida.campoId)} · {estadoLabel[partida.estado]}
        </p>
...
export function PartidasPage() {
  const partidas = publicCatalogMock.listarPartidas();
