    ...
    <>
      ...
      <Section title="Situação operacional">
        <div className="grid grid-cols-2 gap-x-6 gap-y-5 lg:grid-cols-4">
          <StatCard label="Pendentes" value={pending} tone="navy" />
          <StatCard label="Aprovados" value={approved} tone="navy" />
          <StatCard label="Disponíveis" value={available} tone="navy" />
          <StatCard label="Reprovados" value={rejected} tone="navy" />
        </div>
      </Section>
