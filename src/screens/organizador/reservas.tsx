...
export function TelaReservasCampeonato({
  campeonatoId,
}: {
  campeonatoId: string;
}) {
  ...
  const municipal = useEstadoOperacionalPrefeitura();
  ...
  const reservasLocais =
    ...
    catalogoOrganizadorMock.listarReservas(Number(campeonatoId));
  ...
  function solicitar(event: React.FormEvent<HTMLFormElement>) {
    ...
    const registered = registrarReservaMunicipal({
                  ...
                  respeitaAntecedenciaMinima(
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        if (shared) cancelarReservaMunicipal(shared.id);
